...
"***Lvl 202 ~ 230:***\n\nFrom lvl 202, you can start to level up using the Challenge mode feature, it is best to go with a party around your level when attempting Challenge mode. Grind around **Cranto Coast** and do the Challenge mode there. If you still need abit more exp to reach 230 then consider doing some quests too. Neighport Church East Building is a great place to grind too once your daily challenge modes are done.",
...
"***Lvl 350 ~ 390:***\n\nHead over to **Spell Tome Town** and do the Challenge modes there, it is a great place for this due to the narrow areas and high level monsters. Supplement your CM grinds by questing around areas of **Astral Tower, Barynwell Waters, Spell Tome Town and Starry Town**. Monsters will be abit tough so it is reccomended to attempt the Challenge mode grinds and such with a party. It is also a great area to farm for high level loot."
    ]
